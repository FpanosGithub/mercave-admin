...
import { deleteTipoEAVM } from "@/actions/actions_EAVMs"
import { useRouter } from 'next/navigation'

export default function DeleteTipoEAVM({codigo}: {codigo:string}) {
    ...
    return (
        <div className="fixed z-40 w-full h-screen left-0 top-0 bg-black/80 flex flex-col justify-center">
            <div 
                ...
                <p>Por favor confirma que quieres eliminar el TIPO de Eje: </p>
                ...
                <div className="flex justify-end gap-4">
                    ...
                    onClick={() => {startTransition(() => deleteTipoEAVM(codigo)); router.refresh()}}>
                        Eliminar
                    </Link>
                </div>
            </div>

...
export default function TarjetaCambiador({cambiador}:{cambiador: any}) {
    return (
        <div className='border-gray-700 w-56 shadow-lg rounded-lg bg-white p-4 flex flex-col justify-between' key={cambiador.id}>
            <p className="text-center text-xl text-gray-700 truncate">{cambiador.codigo}</p>
            <p className="text-center text-gray-700">{cambiador.tipo}</p>
            <div className="flex justify-end gap-4 mx-4 mt-2">
                <Link href = {`/Cambiadores/${cambiador.codigo}/delete`}>
                ...
                <Link href = {`/Cambiadores/${cambiador.codigo}/edit`}>

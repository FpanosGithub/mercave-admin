...
export default function TarjetaCambiador({cambiador}:{cambiador: CambioBanco}) {
    return (
        <div className='border-gray-700 w-52 shadow-lg rounded-lg bg-white p-4 flex flex-col justify-between' key={cambiador.id}>
            ...
            <div className="flex justify-end gap-4 mx-4 mt-2">
                <Link href = {`/Cambiadores/${cambiador.id}/delete`}>
                ...
                <Link href = {`/Cambiadores/${cambiador.id}/edit`}>
